...
#   - The main strategy:  Raster -> nice raster to do trajectory frequencies
...
#shp1 <- "C:/Users/Peter R/Documents/st_trends_for_c/shp/study_area_subset_v3.shp" # EPSG:3347
...
# K=period, i=trend classes
 ...
 if (global(temp2, fun="notNA")==0) {
   ...
   terra::writeRaster(temp2, paste0(outf1, periodLabs[k], "/", prefix1,i, "_" , frq1, "_v2.tif"), overwrite=FALSE)
